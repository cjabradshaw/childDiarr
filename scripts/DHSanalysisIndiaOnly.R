...
for (i in 1:iter) {
  ...
  # spatial resampling loop
  dat.cresamp <- PHASE1vars.naomit[sample(x=(1:dim(PHASE1vars.naomit)[1]), size=spatsampn, replace=F), ]
...
plot(PHASE2vars$wbmimn, PHASE2vars$diarp, pch=19, xlab="woman bmi", ylab="diarrhoea pr")
  ...
  for (i in 1:iter) {
    ...
    # spatial resampling loop
    dat.cresamp <- PHASE2vars.naomit[sample(x=(1:dim(PHASE2vars.naomit)[1]), size=spatsampn, replace=F), ]
...
for (i in 1:iter) {
  ...
  # spatial resampling loop
  dat.cresamp <- PHASE3vars.naomit[sample(x=(1:dim(PHASE3vars.naomit)[1]), size=spatsampn, replace=F), ]
...
for (i in 1:iter) {
  ...
  # spatial resampling loop
  dat.cresamp <- PHASE4vars.naomit[sample(x=(1:dim(PHASE4vars.naomit)[1]), size=spatsampn, replace=F), ]
...
for (i in 1:iter) {
  ...
  # spatial resampling loop
  dat.cresamp <- PHASE5vars.naomit[sample(x=(1:dim(PHASE5vars.naomit)[1]), size=spatsampn, replace=F), ]
